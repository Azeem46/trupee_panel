...
class Report extends React.Component {
    ...
    columnDefs: [
      ...
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <span>{params.data.T1 || params.data.FT1}</span>
            </div>
          );
        },
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <span>{params.data.T2 || params.data.FT2}</span>
            </div>
          );
        },
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <span>{params.data.T3 || params.data.FT3}</span>
            </div>
          );
        },
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <span>{params.data.T4 || params.data.FT4}</span>
            </div>
          );
        },
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <span>{params.data.t5 || params.data.FT5}</span>
            </div>
          );
        },
      },
      ...
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="actions cursor-pointer"> -- No Action --
              {/* <Trash2
                size={20}
                color="red"
                onClick={() => {
  ...
  alltradeList = () => {
    axiosConfig.get(`/admin/reportTrade`).then((response) => {
  ...
  submitHandler = (e) => {
    ...
    axiosConfig
      .get(
        `/admin/reportTrade?start=${this.state.StartDate}&end=${this.state.EndDate}`
      )
      .then((response) => {
