...
class MlmUserList extends React.Component {
    ...
    columnDefs: [
      ...
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <span>{params.data.userdetails.mobile}</span>
            </div>
          );
        },
      },

      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <span>{params.data.userdetails?.firstname}</span>
            </div>
          );
        },
      },
      ...
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <span>{new Date(params.data.transaction.createdAt).toLocaleString()}</span>
            </div>
          );
        },
      },
  ...
  allUserLis = () => {
    axiosConfig.get("/admin/promocode_lists").then((response) => {
